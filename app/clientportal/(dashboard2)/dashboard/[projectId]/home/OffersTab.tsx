...
import OffersTable_Dashboard from "./OffersTable_Dashboard";
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          ...
          <CardContent className="pl-2">
            <OffersTable_Dashboard offers={offers} />
          </CardContent>
        </Card>
        <Card className="col-span-3">
          <CardHeader>
            <CardTitle>Recently Accepted Offers</CardTitle>
            <CardDescription>
              You successfully won 310 offers this month!
            </CardDescription>
          </CardHeader>
          <CardContent>
